 ...
 * @version 2016-Summer
 */
class SpyHelpAction extends SpyAAction
{
...
//== CONSTRUCTORS AND FACTORY METHODS ==========================================
    ...
    {
        super("pomoc",
              "Vypíše seznam povinných příkazů s popisem");
    }
...
//== OTHER NON-PRIVATE INSTANCE METHODS ========================================
    ...
    {
        SpyGame spyGame = SpyGame.getInstance();
        Collection<SpyAAction> action = spyGame.getAllActions();
        String result = action.stream().map(
                        actions ->    actions.getName() + "\n" +
